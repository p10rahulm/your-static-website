...
1. If you went through the documentation, [Understanding Static Sites](/docs/understand_static_sites/introduction/), then great we have covered most of this. If not, please go through these sub-sections on [how information is stored](/docs/understand_static_sites/static_website_generators/#how-is-information-stored) and [where information is stored](/docs/understand_static_sites/static_website_generators/#where-is-information-stored)
2. The tldr on how information is stored is that configurations are stored in [toml format](https://github.com/toml-lang/toml) and html content is stored in [markdown format](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
3. The tldr on where information is stored is that
